...
| `jsonSchemaConfig`                    | object, class name or `Class`  | none                                      | serializer             | The whole mbknor generator configuration a **POJO-derived** schema is generated with, or a `JsonSchemaConfigFactory` building it. Wins over `jsonSchemaNullableEnabled`. See [the generator section](#configuring-the-json-schema-generator).      |
