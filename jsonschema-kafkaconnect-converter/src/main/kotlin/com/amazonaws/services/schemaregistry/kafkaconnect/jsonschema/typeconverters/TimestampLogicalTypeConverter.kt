...
class TimestampLogicalTypeConverter : TypeConverter {
    override fun toJson(
        schema: Schema?,
        value: Any?,
        ...
        return TypeConverter.JSON_NODE_FACTORY.numberNode(Timestamp.fromLogical(schema, value))
    }
    ...
    override fun toConnect(
        ...
        if (!value.isIntegralNumber()) {
            throw DataException(
                "Invalid type for Timestamp, underlying representation should be integer but was " + value.nodeType,
            )
        }
    ...
    override fun toConnectSchema(
        ...
        jsonSchemaDataConfig: JsonSchemaDataConfig,
    ): SchemaBuilder = throw DataException("Invalid type for Timestamp, underlying type should be integer")
}
