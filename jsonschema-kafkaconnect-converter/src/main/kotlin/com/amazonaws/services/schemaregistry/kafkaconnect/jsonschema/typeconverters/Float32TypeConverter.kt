...
class Float32TypeConverter : TypeConverter {
    override fun toJson(
        schema: Schema?,
        value: Any?,
        config: JsonSchemaDataConfig,
    ): JsonNode = TypeConverter.JSON_NODE_FACTORY.numberNode(value as Float)
    ...
    override fun toJsonSchema(
        ...
        val baseSchemaBuilder = NumberSchema.builder()
