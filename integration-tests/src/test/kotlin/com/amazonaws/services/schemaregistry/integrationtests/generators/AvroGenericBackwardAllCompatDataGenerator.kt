...
class AvroGenericBackwardAllCompatDataGenerator : TestDataGenerator<GenericRecord> {
    override fun createRecords(): List<GenericRecord> {
        ...
        try {
            ...
            schema2 = parser.parse(File("src/test/resources/avro/backwardAll/backwardAll2.avsc"))
            schema3 = parser.parse(File("src/test/resources/avro/backwardAll/backwardAll3.avsc"))
        } catch (e: IOException) {
            e.printStackTrace()
        }
