...
class GlueSchemaRegistryRecordProcessorFactory(
    ...
    override fun shardRecordProcessor(): ShardRecordProcessor = GlueSchemaRegistryRecordProcessor(recordProcessor, glueSchemaRegistryDeserializerFactory, gsrConfig)
}
