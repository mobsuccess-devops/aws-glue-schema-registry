...
class GlueSchemaRegistryKafkaSerializerTest : GlueSchemaRegistryValidationUtil() {
    ...
    fun testConfigure_schemaName_schemaNameMatches() {
        ...
        assertEquals("User-Topic", glueSchemaRegistryKafkaSerializer.schemaName)
        assertNull(glueSchemaRegistryKafkaSerializer.schemaNamingStrategy)
    }

    @ParameterizedTest
    @EnumSource(value = DataFormat::class, mode = EnumSource.Mode.EXCLUDE, names = ["UNKNOWN_TO_SDK_VERSION"])
    fun testConfigure_schemaName_schemaNamingStrategyMatches(dataFormat: DataFormat) {
        ...
        val glueSchemaRegistryKafkaSerializer = GlueSchemaRegistryKafkaSerializer(cred, null)
        glueSchemaRegistryKafkaSerializer.configure(configs, true)
        assertNotNull(glueSchemaRegistryKafkaSerializer.schemaNamingStrategy)
        assertEquals(
            "com.amazonaws.services.schemaregistry.common.AWSSchemaNamingStrategyDefaultImpl",
            glueSchemaRegistryKafkaSerializer.schemaNamingStrategy!!.javaClass.name,
        )
    }

    @ParameterizedTest
    @EnumSource(value = DataFormat::class, mode = EnumSource.Mode.EXCLUDE, names = ["UNKNOWN_TO_SDK_VERSION"])
    fun testConfigure_customerProvidedStrategy_schemaNamingStrategyMatches(dataFormat: DataFormat) {
        val configs = HashMap<String, Any?>()
    ...
    @ParameterizedTest
    @EnumSource(value = DataFormat::class, mode = EnumSource.Mode.EXCLUDE, names = ["UNKNOWN_TO_SDK_VERSION"])
    fun testConfigure_customerProvidedStrategy_throwsException(dataFormat: DataFormat) {
        val configs = HashMap<String, Any?>()
    ...
    fun testConfigure_nullConfigMapWithVersionId_throwsException() {
        ...
        assertThrows(NullPointerException::class.java) {
            glueSchemaRegistryKafkaSerializer.configure(nullOf(), true)
        }
    }
    ...
    fun testSerialize_customerProvidedStrategy_succeeds(compressionType: AWSSchemaRegistryConstants.COMPRESSION) {
        ...
        val serialize = glueSchemaRegistryKafkaSerializer.serialize("User-Topic", genericRecordWithAllTypes)
    ...
    fun testConstructor_defaultCredentialProvider_credentialProviderMatches() {
        ...
        assertNull(glueSchemaRegistryKafkaSerializer.schemaVersionId)
        assertEquals(
            "software.amazon.awssdk.auth.credentials.DefaultCredentialsProvider",
            glueSchemaRegistryKafkaSerializer.credentialProvider!!.javaClass.name,
        )
    }

    @Test
    fun testConstructor_nullCredentialProvider_succeeds() {
        assertDoesNotThrow { GlueSchemaRegistryKafkaSerializer(null, USER_SCHEMA_VERSION_ID, configs) }
    }

    @Test
    fun testConstructor_configMap_succeeds() {
        assertDoesNotThrow { GlueSchemaRegistryKafkaSerializer(configs) }
        val glueSchemaRegistryKafkaSerializer = GlueSchemaRegistryKafkaSerializer(configs)
    ...
    fun testConstructor_nullConfigMapWithVersionId_throwsException() {
        assertThrows(NullPointerException::class.java) {
            GlueSchemaRegistryKafkaSerializer(nullOf<Map<String, Any?>>(), USER_SCHEMA_VERSION_ID)
        }
    }
    ...
    fun testSerialize_customPojos_succeeds(compressionType: AWSSchemaRegistryConstants.COMPRESSION) {
        ...
        val serialize = glueSchemaRegistryKafkaSerializer.serialize("test-topic", userDefinedPojo)
    ...
    fun testSerialize_nullSchemaIdFromAvroSerializer_returnsNullByte() {
        ...
        val glueSchemaRegistryKafkaSerializer = GlueSchemaRegistryKafkaSerializer(configs, null)
        ...
        glueSchemaRegistryKafkaSerializer.glueSchemaRegistrySerializationFacade =
            mockGlueSchemaRegistrySerializationFacade
    ...
    fun testSerialize_parseSchema_succeeds(compressionType: AWSSchemaRegistryConstants.COMPRESSION) {
        ...
        val serialize = glueSchemaRegistryKafkaSerializer.serialize("test-topic", genericUserAvroRecord)
        testForSerializedData(serialize, USER_SCHEMA_VERSION_ID, compressionType)
    }
    ...
    fun testSerialize_multipleRecords_succeeds(compressionType: AWSSchemaRegistryConstants.COMPRESSION) {
        ...
        val userSerializedData = glueSchemaRegistryKafkaSerializer.serialize("test-topic", genericUserAvroRecord)
        testForSerializedData(userSerializedData, USER_SCHEMA_VERSION_ID, compressionType)

        val employeeSerializedData =
            glueSchemaRegistryKafkaSerializer.serialize("test-topic", genericEmployeeAvroRecord)
    ...
    fun testSerialize_preProvidedSchemaVersionId_succeeds(compressionType: AWSSchemaRegistryConstants.COMPRESSION) {
        configs[AWSSchemaRegistryConstants.COMPRESSION_TYPE] = compressionType.name
        val glueSchemaRegistryKafkaSerializer = initializeGSRKafkaSerializer(configs, USER_SCHEMA_VERSION_ID)
        val serializedData = glueSchemaRegistryKafkaSerializer.serialize("test-topic", genericUserAvroRecord)
    ...
    fun testSerialize_sendMultipleMsgs_throwsExceptionAndSchemaVersionIdStateNotSaved(
        ...
        val glueSchemaRegistryKafkaSerializer =
            initializeGSRKafkaSerializer(configs, schemaDefinition, mockSchemaByDefinitionFetcher, null)
        val builder =
        ...
        assertThrows(AWSSchemaRegistryException::class.java) {
            glueSchemaRegistryKafkaSerializer.serialize("test-topic", array1)
        }
        assertThrows(AWSSchemaRegistryException::class.java) {
            glueSchemaRegistryKafkaSerializer.serialize("test-topic", array2)
        }
        assertNull(glueSchemaRegistryKafkaSerializer.schemaVersionId)
    }
